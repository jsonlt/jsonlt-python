...
jsonlt-python is currently in early development. Security updates apply to the latest version only.
...
jsonlt-python supports Python versions that have not reached end-of-life (EOL). When a Python version reaches EOL, the next minor release drops support for that version.
...
If you discover a security vulnerability in jsonlt-python, please report it responsibly.
...
1. Go to the [Security tab](https://github.com/jsonlt/jsonlt-python/security) of the repository
