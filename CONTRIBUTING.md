...
Thank you for your interest in contributing to jsonlt-python.

## Current status

> [!NOTE]
> jsonlt-python is in early development and is not yet accepting pull requests.
...
- **Report bugs** - If you encounter issues while using jsonlt, please open a GitHub issue with a minimal reproducible example
- **Request features** - Have an idea that would make jsonlt more useful? Open an issue to start a discussion
- **Improve documentation** - Found a typo or unclear explanation? Documentation improvements are welcome
- **Share feedback** - Open an issue or discussion about how you're using jsonlt and what could be better
...
- [Tony Burns](https://github.com/tbhb) - Creator and lead maintainer
